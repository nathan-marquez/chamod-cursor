...
const Button: React.FC<ButtonProps> = ({ label, variant = 'primary' }) => {
  ...
  const variantStyles = {
    ...
    filled: 'bg-gradient-to-r from-gray-700 to-gray-800 text-white hover:from-gray-800 hover:to-gray-900 focus:ring-gray-500 shadow-lg hover:shadow-gray-500/25',
  };
