  ...
  },
  {
    ...
    component: (
      <div className="flex flex-col gap-4">
        <Callout message="Your call out text here" icon={<span role="img" aria-label="info">ℹ️</span>} variant="primary" />
        <Callout message="Your call out text here" icon={<span role="img" aria-label="exclamation">⚠️</span>} variant="danger" />
        <Callout message="Your call out text here" icon={<span role="img" aria-label="filled">🔳</span>} variant="filled" />
      </div>
    ),
    exampleMarkup: `
<Callout message="Your call out text here" icon={<span role="img" aria-label="info">ℹ️</span>} variant="primary" />
...
<Callout message="Your call out text here" icon={<span role="img" aria-label="filled">🔳</span>} variant="filled" />`,
    props: [
      ...
      { name: "variant", type: "'primary' | 'danger' | 'filled'", description: "The style variant of the callout.", default: "'primary'" },
    ],
  },
  {
    name: "Card Component",
...
<Tag label="filled" variant="filled" />`,
    props: [
      ...
      { name: "variant", type: "'primary' | 'danger' | 'filled'", description: "The style variant of the tag.", default: "'primary'" },
    ],
  },
];
